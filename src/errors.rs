...
impl ErrorMessage {
    fn to_str(&self) -> String {
        match self {
            ...
            ErrorMessage::EmailExist => "A user with this email already exist".to_string(),
            ...
            ErrorMessage::InvalidToken => "Authentification token is invalid or expired".to_string(),
